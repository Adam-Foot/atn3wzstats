                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingTwo">
                                                        <button className="accordion-button collapsed" type="button"
                                                            ...
                                                            <span className="badge bg-danger me-3">{weeklyGames[0].response2.matches[1].playerStats.teamPlacement} </span>{weeklyGames[0].response2.matches[1].mode === 'br_brquads' ? 'Quads' : weeklyGames[0].response2.matches[1].mode === 'br_brtrios' ? 'Trios' : weeklyGames[0].response2.matches[1].mode === 'br_brduos' ? 'Duos' : weeklyGames[0].response2.matches[1].mode === 'br_brsolo' ? 'Solo' : weeklyGames[0].response2.matches[1].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[0].response2.matches[1].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[0].response2.matches[1].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[0].response2.matches[1].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[0].response2.matches[1].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingFour">
                                                        <button className="accordion-button collapsed" type="button"
                                                            ...
                                                            <span className="badge bg-danger me-3">{weeklyGames[0].response2.matches[3].playerStats.teamPlacement} </span>{weeklyGames[0].response2.matches[3].mode === 'br_brquads' ? 'Quads' : weeklyGames[0].response2.matches[3].mode === 'br_brtrios' ? 'Trios' : weeklyGames[0].response2.matches[3].mode === 'br_brduos' ? 'Duos' : weeklyGames[0].response2.matches[3].mode === 'br_brsolo' ? 'Solo' : weeklyGames[0].response2.matches[3].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[0].response2.matches[3].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[0].response2.matches[3].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[0].response2.matches[3].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[0].response2.matches[3].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingFive">
                                                        <button className="accordion-button collapsed" type="button"
                                                            ...
                                                            <span className="badge bg-danger me-3">{weeklyGames[0].response2.matches[4].playerStats.teamPlacement} </span>{weeklyGames[0].response2.matches[4].mode === 'br_brquads' ? 'Quads' : weeklyGames[0].response2.matches[4].mode === 'br_brtrios' ? 'Trios' : weeklyGames[0].response2.matches[4].mode === 'br_brduos' ? 'Duos' : weeklyGames[0].response2.matches[4].mode === 'br_brsolo' ? 'Solo' : weeklyGames[0].response2.matches[4].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[0].response2.matches[4].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[0].response2.matches[4].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[0].response2.matches[4].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[0].response2.matches[4].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingTwo">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseTwo">
                                                            <span className="badge bg-danger me-3">{weeklyGames[1].response2.matches[1].playerStats.teamPlacement} </span>{weeklyGames[1].response2.matches[1].mode === 'br_brquads' ? 'Quads' : weeklyGames[1].response2.matches[1].mode === 'br_brtrios' ? 'Trios' : weeklyGames[1].response2.matches[1].mode === 'br_brduos' ? 'Duos' : weeklyGames[1].response2.matches[1].mode === 'br_brsolo' ? 'Solo' : weeklyGames[1].response2.matches[1].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[1].response2.matches[1].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[1].response2.matches[1].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[1].response2.matches[1].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[1].response2.matches[1].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingFour">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseFour">
                                                            <span className="badge bg-danger me-3">{weeklyGames[1].response2.matches[3].playerStats.teamPlacement} </span>{weeklyGames[1].response2.matches[3].mode === 'br_brquads' ? 'Quads' : weeklyGames[1].response2.matches[3].mode === 'br_brtrios' ? 'Trios' : weeklyGames[1].response2.matches[3].mode === 'br_brduos' ? 'Duos' : weeklyGames[1].response2.matches[3].mode === 'br_brsolo' ? 'Solo' : weeklyGames[1].response2.matches[3].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[1].response2.matches[3].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[1].response2.matches[3].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[1].response2.matches[3].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[1].response2.matches[3].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingFive">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseFive">
                                                            <span className="badge bg-danger me-3">{weeklyGames[1].response2.matches[4].playerStats.teamPlacement} </span>{weeklyGames[1].response2.matches[4].mode === 'br_brquads' ? 'Quads' : weeklyGames[1].response2.matches[4].mode === 'br_brtrios' ? 'Trios' : weeklyGames[1].response2.matches[4].mode === 'br_brduos' ? 'Duos' : weeklyGames[1].response2.matches[4].mode === 'br_brsolo' ? 'Solo' : weeklyGames[1].response2.matches[4].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[1].response2.matches[4].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[1].response2.matches[4].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[1].response2.matches[4].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[1].response2.matches[4].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingTwo">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseTwo">
                                                            <span className="badge bg-danger me-3">{weeklyGames[2].response2.matches[1].playerStats.teamPlacement} </span>{weeklyGames[2].response2.matches[1].mode === 'br_brquads' ? 'Quads' : weeklyGames[2].response2.matches[1].mode === 'br_brtrios' ? 'Trios' : weeklyGames[2].response2.matches[1].mode === 'br_brduos' ? 'Duos' : weeklyGames[2].response2.matches[1].mode === 'br_brsolo' ? 'Solo' : weeklyGames[2].response2.matches[1].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[2].response2.matches[1].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[2].response2.matches[1].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[2].response2.matches[1].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[2].response2.matches[1].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingFour">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseFour">
                                                            <span className="badge bg-danger me-3">{weeklyGames[2].response2.matches[3].playerStats.teamPlacement} </span>{weeklyGames[2].response2.matches[3].mode === 'br_brquads' ? 'Quads' : weeklyGames[2].response2.matches[3].mode === 'br_brtrios' ? 'Trios' : weeklyGames[2].response2.matches[3].mode === 'br_brduos' ? 'Duos' : weeklyGames[2].response2.matches[3].mode === 'br_brsolo' ? 'Solo' : weeklyGames[2].response2.matches[3].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[2].response2.matches[3].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[2].response2.matches[3].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[2].response2.matches[3].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[2].response2.matches[3].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingFive">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseFive">
                                                            <span className="badge bg-danger me-3">{weeklyGames[2].response2.matches[4].playerStats.teamPlacement} </span>{weeklyGames[2].response2.matches[4].mode === 'br_brquads' ? 'Quads' : weeklyGames[2].response2.matches[4].mode === 'br_brtrios' ? 'Trios' : weeklyGames[2].response2.matches[4].mode === 'br_brduos' ? 'Duos' : weeklyGames[2].response2.matches[4].mode === 'br_brsolo' ? 'Solo' : weeklyGames[2].response2.matches[4].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[2].response2.matches[4].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[2].response2.matches[4].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[2].response2.matches[4].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[2].response2.matches[4].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingTwo">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseTwo">
                                                            <span className="badge bg-danger me-3">{weeklyGames[3].response2.matches[1].playerStats.teamPlacement} </span>{weeklyGames[3].response2.matches[1].mode === 'br_brquads' ? 'Quads' : weeklyGames[3].response2.matches[1].mode === 'br_brtrios' ? 'Trios' : weeklyGames[3].response2.matches[1].mode === 'br_brduos' ? 'Duos' : weeklyGames[3].response2.matches[1].mode === 'br_brsolo' ? 'Solo' : weeklyGames[3].response2.matches[1].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[3].response2.matches[1].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[3].response2.matches[1].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[3].response2.matches[1].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[3].response2.matches[1].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingFour">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseFour">
                                                            <span className="badge bg-danger me-3">{weeklyGames[3].response2.matches[3].playerStats.teamPlacement} </span>{weeklyGames[3].response2.matches[3].mode === 'br_brquads' ? 'Quads' : weeklyGames[3].response2.matches[3].mode === 'br_brtrios' ? 'Trios' : weeklyGames[3].response2.matches[3].mode === 'br_brduos' ? 'Duos' : weeklyGames[3].response2.matches[3].mode === 'br_brsolo' ? 'Solo' : weeklyGames[3].response2.matches[3].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[3].response2.matches[3].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[3].response2.matches[3].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[3].response2.matches[3].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[3].response2.matches[3].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingFive">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseFive">
                                                            <span className="badge bg-danger me-3">{weeklyGames[3].response2.matches[4].playerStats.teamPlacement} </span> {weeklyGames[3].response2.matches[4].mode === 'br_brquads' ? 'Quads' : weeklyGames[3].response2.matches[4].mode === 'br_brtrios' ? 'Trios' : weeklyGames[3].response2.matches[4].mode === 'br_brduos' ? 'Duos' : weeklyGames[3].response2.matches[4].mode === 'br_brsolo' ? 'Solo' : weeklyGames[3].response2.matches[4].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[3].response2.matches[4].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[3].response2.matches[4].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[3].response2.matches[4].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[3].response2.matches[4].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingTwo">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseTwo">
                                                            <span className="badge bg-danger me-3">{weeklyGames[4].response2.matches[1].playerStats.teamPlacement} </span>{weeklyGames[4].response2.matches[1].mode === 'br_brquads' ? 'Quads' : weeklyGames[4].response2.matches[1].mode === 'br_brtrios' ? 'Trios' : weeklyGames[4].response2.matches[1].mode === 'br_brduos' ? 'Duos' : weeklyGames[4].response2.matches[1].mode === 'br_brsolo' ? 'Solo' : weeklyGames[4].response2.matches[1].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[4].response2.matches[1].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[4].response2.matches[1].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[4].response2.matches[1].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[4].response2.matches[1].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingFour">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseFour">
                                                            <span className="badge bg-danger me-3">{weeklyGames[4].response2.matches[3].playerStats.teamPlacement} </span>{weeklyGames[4].response2.matches[3].mode === 'br_brquads' ? 'Quads' : weeklyGames[4].response2.matches[3].mode === 'br_brtrios' ? 'Trios' : weeklyGames[4].response2.matches[3].mode === 'br_brduos' ? 'Duos' : weeklyGames[4].response2.matches[3].mode === 'br_brsolo' ? 'Solo' : weeklyGames[4].response2.matches[3].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[4].response2.matches[3].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[4].response2.matches[3].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[4].response2.matches[3].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[4].response2.matches[3].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                                                ...
                                                <div className="accordion-item">
                                                    <h2 className="accordion-header" id="headingFive">
                                                        <button className="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseFive">
                                                            <span className="badge bg-danger me-3">{weeklyGames[4].response2.matches[4].playerStats.teamPlacement} </span> {weeklyGames[4].response2.matches[4].mode === 'br_brquads' ? 'Quads' : weeklyGames[4].response2.matches[4].mode === 'br_brtrios' ? 'Trios' : weeklyGames[4].response2.matches[4].mode === 'br_brduos' ? 'Duos' : weeklyGames[4].response2.matches[4].mode === 'br_brsolo' ? 'Solo' : weeklyGames[4].response2.matches[4].mode === 'br_rebirth_rbrthtrios' ? 'Rebirth Trios' : weeklyGames[4].response2.matches[4].mode === 'br_rebirth_rbrthduos' ? 'Rebirth Duos' : weeklyGames[4].response2.matches[4].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Solo' : weeklyGames[4].response2.matches[4].mode === 'br_rebirth_rbrthsolo' ? 'Rebirth Quads' : weeklyGames[4].response2.matches[4].mode === 'brtdm_rmbl' ? 'Warzone Rumble' : 'Unknown Gamemode'}
                                                        </button>
                                                    </h2>
                        ...
                        <div className="tab-pane fade" id="updates" role="tabpanel" aria-labelledby="updates-tab">
                            <div className="row mt-3">
                                <div className="col-12 col-md-10 col-lg-8 mb-3 text-white">
                                    ...
                                    <ul>
                                        <li>Show date & time of recent matches</li>
